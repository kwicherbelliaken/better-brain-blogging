...
const FlowerBlobTransition = ({
  ...
  useEffect(() => {
    ...
    // invoke the relevant animation against the relevant DOM node target
    animationTarget && ANIMATION_TARGETS[animationTarget].animate(domNodes);
            ...
            <div className="relative">
              ...
              >
                <clipPath id="clip-shape">
                  {ANIMATION_TARGETS[animationTarget].Component}
                </clipPath>
